...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.arrivingStationCombo.setItemText(1, _translate("MainWindow", "Earlswood (Surrey)", None))
        self.arrivingStationCombo.setItemText(2, _translate("MainWindow", "Merstham", None))
        self.arrivingStationCombo.setItemText(3, _translate("MainWindow", "London Victoria", None))
        self.arrivingStationCombo.setItemText(4, _translate("MainWindow", "London Bridge", None))
        self.arrivingStationCombo.setItemText(5, _translate("MainWindow", "East Croydon", None))
        ...
        self.departingStationCombo.setItemText(1, _translate("MainWindow", "Earlswood (Surrey)", None))
        self.departingStationCombo.setItemText(2, _translate("MainWindow", "Merstham", None))
        self.departingStationCombo.setItemText(3, _translate("MainWindow", "London Victoria", None))
        self.departingStationCombo.setItemText(4, _translate("MainWindow", "London Bridge", None))
        self.departingStationCombo.setItemText(5, _translate("MainWindow", "East Croydon", None))
